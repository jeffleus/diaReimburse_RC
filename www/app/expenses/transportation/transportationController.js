...
.controller('TransportationCtrl', function($scope, $log, TransportationExp, TripSvc) {
    
    $scope.vm = [];
    $scope.$on('modal.shown', function() {
        $log.log('Transportation Controller...');
    ...
    $scope.saveNew = function() {
        ...
        if (isDirty) {
            $log.log('TransportationCtrl: save new expense');
